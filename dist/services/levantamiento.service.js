...
export async function crearLevantamientoService(data) {
...
export async function listarLevantamientosService(no_siniestro) {
...
export async function obtenerLevantamientoPorIdService(id) {
...
export async function obtenerLevantamientoPorSiniestroService(no_siniestro) {
...
export async function actualizarLevantamientoService(id, data) {
...
export async function agregarConceptoService(id_levantamiento, concepto) {
...
export async function eliminarConceptoService(id_concepto) {
...
export async function eliminarLevantamientoService(id) {
    const levantamiento = await prisma.levantamiento_danios.findUnique({
        where: { id },
    });
    if (!levantamiento) {
...
export async function calcularCostoTotalService(id) {
    const levantamiento = await prisma.levantamiento_danios.findUnique({
        where: { id },
    });
    if (!levantamiento) {
