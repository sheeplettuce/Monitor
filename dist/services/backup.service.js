...
export async function subirArchivoRespaldo(filePath, key) {
 ...
 */
export async function generarUrlFirmada(key, expiraSegundos = 900) {
...
export async function eliminarArchivoB2(key) {
 ...
 */
export async function subirCarpetaEvidencias(carpetaLocal, no_siniestro) {
    const keysSubidas = [];
